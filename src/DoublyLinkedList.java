...
public class DoublyLinkedList implements IntList{
    ...
    private class Node{
        ...
        Node next; //address of the node after

        Node prev; //address of the node before
    ...
    public void addBack(int value) {
        ...
        //setup the new node and fill it out (data, prev, next)
    ...
    public void removeBack() {
        //setup a variable for convenience
